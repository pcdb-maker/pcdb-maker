...
I'm a freelance fullstack web-developer and digital artist.

### Languages and tools I am proficient with: 
<img src="https://en.wikipedia.org/wiki/File:WordPress_blue_logo.svg" width="50" height="50"><img src="https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg" width="50" height="50">
...
### Languages/Libraries: 
Beginner self-taught JavaScript (ES7), Java, React.Js, C#, HTML, CSS, Typescript.
### Technologies: 
Beginner self-taught Three.Js, WordPress, Stripe, Square, Blendr, MongoDB, Node, Nodemon, Postman, Gulp, Yarn, NPM, Next, Vue, Vite, Jest, Figma, Redux.
