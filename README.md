...
I'm a freelance front-end web-developer and digital artist.
...
Languages/Libraries: Beginner JavaScript (ES7), Java, React.Js, HTML, CSS, Typescript, C#.
Technologies: MongoDB, Node, Nodemon, Three.Js, Postman, Gulp, Yarn, NPM, Next, Vue, Vite, Jest, Figma, Redux.
